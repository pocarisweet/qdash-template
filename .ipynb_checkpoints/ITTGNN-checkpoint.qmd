...
FiveVTS_random = pd.merge(df.query("dataset=='fivenodes' and mtype=='rand'").groupby(['model','mrate','nof_filters','inter_method','method','lags','epoch'])['mse'].mean().reset_index(),
         ...
         on=['model','mrate','inter_method','method','nof_filters','mrate','lags','epoch']).rename(columns={'mse_x':'mean','mse_y':'std','mrate':'Missing Rate','inter_method':'Interpolation','nof_filters':'Filters'}).query("mrate==0.7 and inter_method=='linear'").assign(Method=lambda x: x['method'].map({'STGCN': 'Classic', 'IT-STGCN': 'Proposed','GNAR':'GNAR'})).drop(columns=['method','epoch'])
...
FiveVTS_block = pd.merge(df.query("dataset=='fivenodes' and mtype=='block'").groupby(['model','mrate','nof_filters','inter_method','method','epoch'])['mse'].mean().reset_index(),
         ...
         on=['model','inter_method','method','nof_filters','mrate','epoch']).rename(columns={'mse_x':'mean','mse_y':'std','mrate':'Missing Rate','inter_method':'Interpolation','nof_filters':'Filters'}).query("inter_method=='linear'").assign(Method=lambda x: x['method'].map({'STGCN': 'Classic', 'IT-STGCN': 'Proposed','GNAR':'GNAR'})).drop(columns=['method','epoch'])
...
Chickenpox_block = pd.merge(df.query("dataset=='chickenpox' and mtype=='block'").groupby(['model','inter_method','mrate','nof_filters','method','lags'])['mse'].mean().reset_index(),
         ...
         on=['model','method','inter_method','mrate','nof_filters']).rename(columns={'mse_x':'mean','mse_y':'std','mrate':'Missing Rate','inter_method':'Interpolation','nof_filters':'Filters'}).query("inter_method=='linear'").assign(Method=lambda x: x['method'].map({'STGCN': 'Classic', 'IT-STGCN': 'Proposed','GNAR':'GNAR'})).drop(columns=['method'])
...
Pedalme_Random = pd.merge(df.query("dataset=='pedalme' and mtype=='rand'").groupby(['model','mrate','lags','inter_method','method','nof_filters'])['mse'].mean().reset_index(),
         ...
         on=['model','method','mrate','lags','inter_method','nof_filters']).rename(columns={'mse_x':'mean','mse_y':'std','mrate':'Missing Rate','inter_method':'Interpolation','nof_filters':'Filters'}).query("inter_method=='nearest'").assign(Method=lambda x: x['method'].map({'STGCN': 'Classic', 'IT-STGCN': 'Proposed','GNAR':'GNAR'})).drop(columns=['method'])
...
Pedalme_block = pd.merge(df.query("dataset=='pedalme' and mtype=='block'").groupby(['model','mrate','lags','inter_method','method','nof_filters'])['mse'].mean().reset_index(),
         ...
         on=['model','method','mrate','lags','inter_method','nof_filters']).rename(columns={'mse_x':'mean','mse_y':'std','mrate':'Missing Rate','inter_method':'Interpolation','nof_filters':'Filters'}).query("lags==4 and inter_method=='nearest'").assign(Method=lambda x: x['method'].map({'STGCN': 'Classic', 'IT-STGCN': 'Proposed','GNAR':'GNAR'})).drop(columns=['method'])
...
MontevideoBus_block = pd.merge(df.query("dataset=='monte' and mtype=='block'").groupby(['model','mrate','lags','inter_method','method','nof_filters'])['mse'].mean().reset_index(),
         ...
         on=['model','method','mrate','inter_method','lags','nof_filters']).rename(columns={'mse_x':'mean','mse_y':'std','mrate':'Missing Rate','inter_method':'Interpolation','nof_filters':'Filters'}).query("inter_method=='nearest'").assign(Method=lambda x: x['method'].map({'STGCN': 'Classic', 'IT-STGCN': 'Proposed','GNAR':'GNAR'})).drop(columns=['method'])
