...
fivenodes_fig2 = (ggplot(fivenodes_fig, aes(x='mrate', y='log10(mse)', group='interaction(mrate, method)')) +
      ...
      theme(strip_background=element_blank(), strip_placement="outside", panel_grid=element_blank(),
